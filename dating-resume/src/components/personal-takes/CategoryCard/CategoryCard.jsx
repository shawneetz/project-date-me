/**
 * CategoryCard
 * Purpose: Individual category button card in the takes grid - triggers modal on click
 */
...
export default function CategoryCard({ category, onOpen, index }) {
  ...
  return (
    ...
    >
      ...
      <span className="takes-category-card__cta-reveal" aria-hidden>
        <span className="takes-category-card__cta-reveal-inner">
          <span className="takes-category-card__cta">View all →</span>
        </span>
      </span>
    </motion.button>
  );
